...
class PipelineTests(unittest.TestCase):
    ...
    def test_web_shell_contains_analysis_controls(self) -> None:
        ...
        self.assertIn('id="mappingBanner"', html)
        self.assertIn('id="planExclusions"', html)
        self.assertIn("已排除映射", html)
        self.assertIn("可分析文件覆盖", html)
        self.assertIn("plan.excluded_mappings || []", html)
        self.assertIn('id="severityFilters"', html)
        self.assertIn('id="actionFilters"', html)
        self.assertIn('data-action="add"', html)
        self.assertIn('data-action="delete"', html)
        self.assertIn('data-action="modify"', html)
        ...
        self.assertIn("建议动作筛选", html)
        self.assertIn("groupActionType", html)
        self.assertIn("actionMatches", html)
        self.assertIn('class="action-chip ${esc(group.actionType)}"', html)
